...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        try {
            // 1. Clear any old session data first (Prevents admin@test.com data from lingering)
            ...
            if (res.data.token) {
                ...
                // 4. Force a page reload to clear any remaining React state or cached API data
                window.location.reload(); 
            } else {
                // Fallback if backend only returns success message without token
